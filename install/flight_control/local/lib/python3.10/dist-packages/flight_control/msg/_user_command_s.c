...
bool flight_control__msg__user_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("flight_control.msg._user_command.UserCommand", full_classname_dest, 44) == 0);
  }
  flight_control__msg__UserCommand * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // use_xyz
    PyObject * field = PyObject_GetAttrString(_pymsg, "use_xyz");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->use_xyz = (Py_True == field);
    Py_DECREF(field);
  }
  {  // response
...
PyObject * flight_control__msg__user_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("flight_control.msg._user_command");
  ...
  {  // use_xyz
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->use_xyz ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "use_xyz", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
