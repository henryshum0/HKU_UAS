...
bool offboard_control_interfaces__msg__user_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("offboard_control_interfaces.msg._user_command.UserCommand", full_classname_dest, 57) == 0);
  }
  offboard_control_interfaces__msg__UserCommand * ros_message = _ros_message;
  {  // timestamp
...
PyObject * offboard_control_interfaces__msg__user_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("offboard_control_interfaces.msg._user_command");
