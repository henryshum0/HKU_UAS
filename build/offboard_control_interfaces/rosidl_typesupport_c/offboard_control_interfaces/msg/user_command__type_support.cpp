...
static const _UserCommand_type_support_symbol_names_t _UserCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, offboard_control_interfaces, msg, UserCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, offboard_control_interfaces, msg, UserCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, offboard_control_interfaces, msg, UserCommand)() {
  return &::offboard_control_interfaces::msg::rosidl_typesupport_c::UserCommand_message_type_support_handle;
}
