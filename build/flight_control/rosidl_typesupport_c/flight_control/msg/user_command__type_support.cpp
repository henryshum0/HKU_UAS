...
static const _UserCommand_type_support_symbol_names_t _UserCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flight_control, msg, UserCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, flight_control, msg, UserCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, flight_control, msg, UserCommand)() {
  return &::flight_control::msg::rosidl_typesupport_c::UserCommand_message_type_support_handle;
}
