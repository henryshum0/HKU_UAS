...
#include "flight_control/msg/detail/user_command__rosidl_typesupport_fastrtps_c.h"
...
#include "flight_control/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _UserCommand__ros_msg_type = flight_control__msg__UserCommand;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_flight_control
size_t get_serialized_size_flight_control__msg__UserCommand(
  const void * untyped_ros_message,
...
static uint32_t _UserCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_flight_control__msg__UserCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_flight_control
size_t max_serialized_size_flight_control__msg__UserCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = flight_control__msg__UserCommand;
    is_plain =
      (
...
static size_t _UserCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_flight_control__msg__UserCommand(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, flight_control, msg, UserCommand)() {
