...
static const _UserCommand_type_support_symbol_names_t _UserCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, flight_control, msg, UserCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, flight_control, msg, UserCommand)),
  }
};
...
{
  return &::flight_control::msg::rosidl_typesupport_cpp::UserCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, flight_control, msg, UserCommand)() {
  return get_message_type_support_handle<flight_control::msg::UserCommand>();
}
